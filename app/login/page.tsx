...
const TAURI_REDIRECT = "pingnouille://auth/callback";
...
export default function LoginPage() {
  ...
  // pingnouille://auth/callback, capté ci-dessous, qu'on échange contre une session.
  useEffect(() => {
    if (!isTauri()) return;
    ...
    >
      <div style={{ width: "100%", maxWidth: 360 }}>
        ...
        <div style={{ display: "flex", alignItems: "center", gap: 10, marginBottom: 32 }}>
          ...
          <div style={{ fontSize: 16, fontWeight: 600, color: "var(--color-text, #0D0D0D)" }}>pingnouille</div>
        </div>
