...
export function SourceNotice({ live }) {
  ...
  if (web) rows.push({
    ...
    title: "Sur cet appareil, seul pingnouille est mesuré",
  ...
  if (denied) rows.push({
    ...
    body: "macOS demande l'autorisation « Accessibilité » pour lire le titre de la fenêtre active. Réglages système → Confidentialité et sécurité → Accessibilité, puis coche pingnouille. Le temps par application, lui, est bien mesuré.",
  });
