 ...
 *     jusqu'à l'app elle-même (dont le processus s'appelait « tao ») tombaient
...
export const CATALOG: CatalogEntry[] = [
  ...
  ...of("admin", [
    /* pingnouille en premier : c'est CETTE app. Les anciens noms restent dans la
       liste — un binaire « tao » encore installé et l'historique déjà mesuré
       doivent continuer à se reconnaître, sinon un mois de journal se retrouve
       « Non classé ». « tao » fait trois lettres et ne peut donc pas être
       cherché comme un fragment : d'où la correspondance exacte. */
    { name: "pingnouille", app: ["pingnouille", "tao", "tao trade", "taotrade", "tr4de"], web: ["pingnouille.vercel.app", "tao-trade.vercel.app"], title: ["pingnouille", "tao trade"] },
