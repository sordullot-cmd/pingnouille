...
/* Le lien « page Discipline → Vie RPG » (chaque règle de trading respectée
   créditait la catégorie « Trading » en XP) est parti avec la page Discipline,
   dans l'app trading. Les helpers qui résolvaient cette carte particulière
   (`resolveTradingCatId`, `hasTradingCategory`) n'avaient plus d'appelant. */
