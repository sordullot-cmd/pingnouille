...
Le côté Kotlin est dans `gen/android/app/src/main/java/app/pingnouille/desktop/
...
pub fn init<R: Runtime>() -> TauriPlugin<R> {
  Builder::new("phone")
    .setup(|_app, _api| {
      ...
      {
        use tauri::Manager;
        let handle = _api.register_android_plugin("app.pingnouille.desktop", "PhonePlugin")?;
